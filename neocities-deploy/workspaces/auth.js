...
import { app, esc, showToast } from '../state.js?v=e2bd7e8507fa';
...
import {
  ...
  signOut,
  subscribe,
} from '../play/network/auth-controller.js?v=e2bd7e8507fa';
import { legalAcknowledgmentHtml } from '../legal-pages.js?v=e2bd7e8507fa';
