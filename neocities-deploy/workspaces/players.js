...
import { fetchDirectory } from '../play/players/players-data.js?v=9ea1c2f9e91d';
import { fetchRecentOpponents } from '../play/players/recent-opponents-data.js?v=9ea1c2f9e91d';
import {
  fetchRelationships,
...
async function handleQuickRival(target, pid, btn) {
  ...
  const { setRival } = await import('../play/players/relationships-data.js?v=9ea1c2f9e91d');
  btn.disabled = true;
