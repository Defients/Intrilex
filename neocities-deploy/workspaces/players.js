...
import { app, esc, pct } from '../state.js?v=75c53031ef21';
...
import { fetchDirectory } from '../play/players/players-data.js?v=75c53031ef21';
import { fetchRecentOpponents } from '../play/players/recent-opponents-data.js?v=75c53031ef21';
import {
  fetchRelationships,
...
async function handleQuickRival(target, pid, btn) {
  ...
  const { setRival } = await import('../play/players/relationships-data.js?v=75c53031ef21');
  btn.disabled = true;
