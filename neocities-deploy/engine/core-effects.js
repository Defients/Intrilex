...
function profileActive(state) { const profileId = state.metadata.coreAuthority?.profileId; return profileId === CORE_EFFECT_DECLARATION_PROFILE.id || profileId === "core-response-authority" || profileId === "core-private-choice-authority" || profileId === "core-advanced-authority" || profileId === "core-unrestricted-authority"; }
function privateChoiceProfile(state) { const profileId = state.metadata.coreAuthority?.profileId; return profileId === "core-private-choice-authority" || profileId === "core-advanced-authority" || profileId === "core-unrestricted-authority"; }
