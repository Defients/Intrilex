...
import { classifyDecisionKind, presentAction } from './action-presenter.js?v=42162e3d88b3';
import {
  PRODUCT_VERSION,
  ...
  canMigrateSave,
  migrateSave,
} from './save-integrity.js?v=42162e3d88b3';
import { createPolicyRng, computePlayerStats } from './session-utils.js?v=42162e3d88b3';
...
async function engine() {
  if (!_engineModule) {
    _engineModule = await import('../engine/browser-entry.js?v=42162e3d88b3');
  }
...
async function autonomy() {
  if (!_autonomyModule) {
    _autonomyModule = await import('../autonomy-runtime.js?v=42162e3d88b3');
  }
