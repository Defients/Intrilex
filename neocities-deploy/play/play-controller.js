...
import { classifyDecisionKind, presentAction } from './action-presenter.js?v=e2bd7e8507fa';
import {
  PRODUCT_VERSION,
  ...
  canMigrateSave,
  migrateSave,
} from './save-integrity.js?v=e2bd7e8507fa';
import { createPolicyRng, computePlayerStats } from './session-utils.js?v=e2bd7e8507fa';
...
async function engine() {
  if (!_engineModule) {
    _engineModule = await import('../engine/browser-entry.js?v=e2bd7e8507fa');
  }
...
async function autonomy() {
  if (!_autonomyModule) {
    _autonomyModule = await import('../autonomy-runtime.js?v=e2bd7e8507fa');
  }
