...
import { classifyDecisionKind, presentAction } from './action-presenter.js?v=73b458295383';
import {
  PRODUCT_VERSION,
  ...
  canMigrateSave,
  migrateSave,
} from './save-integrity.js?v=73b458295383';
import { createPolicyRng, computePlayerStats } from './session-utils.js?v=73b458295383';
...
async function engine() {
  if (!_engineModule) {
    _engineModule = await import('../engine/browser-entry.js?v=73b458295383');
  }
...
async function autonomy() {
  if (!_autonomyModule) {
    _autonomyModule = await import('../autonomy-runtime.js?v=73b458295383');
  }
