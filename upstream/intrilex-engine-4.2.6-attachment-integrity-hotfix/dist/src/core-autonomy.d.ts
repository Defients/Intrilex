...
export declare function canRecurseTopdeck(state: EngineState, sourceCardId: CardId): boolean;
...
export declare function coreAuthorityCapabilities(): ({
    ...
    moduleSets: never[][];
    status: string;
    completeActionFamilies: ("draw" | "play-for-points" | "scuttle" | "exhausted-pass" | "face-up-swap" | "king-spade-counter" | "rank10-stack-theft" | "ultra-three-red" | "royal-marriage" | "queens-court" | "wild-sovereignty" | "super-ace" | "A-purge" | "A-anchor" | "3-bounce" | "4-row-clear" | "4-spade-total-clear" | "J-attachment" | "Q-anchor" | "K-anchor" | "RJ-four-modes" | "BJ-board-lock" | "3-present-take" | "3-force-discard" | "5-recycle-rummage" | "6-deep-dig" | "7-topdeck-casting" | "9-anchor-discard" | "super-two-score" | "super-two-hold" | "super-four-exchange" | "super-eight" | "super-jack" | "rank10-heart" | "rank10-spade-recovery" | "rank10-diamond-mimic" | "rank10-club-foundation" | "board-lock" | "ultra-three-black-public" | "ultra-two-black-two-red" | "voltage-five-gy-bottom" | "voltage-three-choice" | "voltage-four-prediction" | "voltage-five-refine" | "special-scoring-riders" | "A-base-counter" | "A-anchor-counter" | "A-spade-exile-counter" | "8-scuttle-counter" | "8-spade-free-scuttle" | "8-aegis-field-quick" | "9-tap" | "J-disrupt" | "Q-aegis-quick" | "K-anchor-counter" | "face-down-swap")[];
    reasonCodes: string[];
} | {
