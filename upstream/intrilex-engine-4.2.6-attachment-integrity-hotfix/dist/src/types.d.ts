...
export type FirstContactMiniTurnActionType = "draw" | "play-for-points" | "play-for-effect" | "scuttle" | "exhausted-pass";
...
export type FirstContactPrimaryAction = {
    ...
    kind: "autonomy-scuttle";
    sourceCardId: CardId;
    targetCardId: CardId;
} | {
    kind: "autonomy-four-clear";
    sourceCardId: CardId;
    targetPlayerId: PlayerId;
    row: "pr" | "er";
} | {
    kind: "autonomy-nine-tap";
    sourceCardId: CardId;
    targetCardId: CardId;
} | {
    kind: "autonomy-nine-goal-shift";
    sourceCardId: CardId;
    targetPlayerId: PlayerId;
    delta: 3 | 5;
    discardCardId?: CardId;
} | {
    kind: "autonomy-jack-pr-attachment";
    sourceCardId: CardId;
    targetCardId: CardId;
} | {
    kind: "autonomy-queen-anchor";
    sourceCardId: CardId;
} | {
    kind: "autonomy-king-anchor";
    sourceCardId: CardId;
} | {
    kind: "autonomy-red-joker";
    sourceCardId: CardId;
    mode: "hand-swap" | "self-reset" | "opponent-attack" | "shuffle-reset";
    targetPlayerId?: PlayerId;
} | {
    kind: "autonomy-black-joker-board-lock";
    sourceCardId: CardId;
} | {
    kind: "autonomy-three-hand-raid";
    sourceCardId: CardId;
    targetPlayerId: PlayerId;
    mode: "present-take" | "force-discard";
} | {
    kind: "autonomy-three-bounce";
    sourceCardId: CardId;
    targetCardId: CardId;
    destination: "top" | "bottom";
} | {
    kind: "autonomy-five-recycle";
    sourceCardId: CardId;
} | {
    kind: "autonomy-six-dig";
    sourceCardId: CardId;
} | {
    kind: "autonomy-seven-topdeck";
    sourceCardId: CardId;
} | {
    kind: "autonomy-nine-anchor";
    sourceCardId: CardId;
    targetPlayerId: PlayerId;
} | {
    kind: "autonomy-exhausted-pass";
};
export type FirstContactStackPayload = {
    kind: "primary";
    action: FirstContactPrimaryAction;
    ...
    kind: "jack-disrupt";
    targetStackItemId: StackItemId;
    disruptedActionType: FirstContactMiniTurnActionType;
} | {
    kind: "seven-scoring-trigger";
    sourceCardId: CardId;
};
export type FirstContactPrivateChoiceKind = "rank3-present" | "rank3-take" | "rank3-discard" | "rank5-rummage" | "rank6-dig" | "rank7-assign" | "rank7-generated-effect" | "rank7-scoring-trigger" | "nine-anchor-discard";
...
export type FirstContactPrivateChoiceSubmission = {
    ...
    kind: "rank6-dig";
    mode: "keep-return-top" | "keep-return-bottom" | "keep-all-discard";
    selectedCardIds: CardId[];
} | {
    kind: "rank7-assign";
    mode: "hand-only" | "effect-only" | "hand-and-effect" | "score-only" | "hand-and-score";
    selectedCardIds: CardId[];
} | {
    kind: "rank7-generated-effect";
    selectedCardIds: CardId[];
    generatedAction?: FirstContactPrimaryAction;
    scoreInstead?: boolean;
} | {
    kind: "rank7-scoring-trigger";
    selectedCardIds: CardId[];
} | {
    kind: "nine-anchor-discard";
    selectedCardIds: CardId[];
};
...
export type CoreFoundationActionType = "draw" | "face-up-swap" | "play-for-points" | "play-for-effect" | "scuttle" | "exhausted-pass";
export type CoreAuthorityProfileId = "core-foundation-authority" | "core-effect-declaration-authority" | "core-response-authority" | "core-private-choice-authority" | "core-advanced-authority" | "core-unrestricted-authority";
export type CoreAdvancedAction = {
    kind: "advanced-royal-marriage";
    kingCardId: CardId;
    queenCardId: CardId;
} | {
    kind: "advanced-queens-court";
    queenCardIds: [CardId, CardId];
} | {
    ...
    kind: "advanced-super-four-exchange";
    sourceCardIds: [CardId, CardId];
    targetPlayerId: PlayerId;
    row: "pr" | "er";
} | {
    ...
    kind: "advanced-super-j-tempo";
    sourceCardIds: [CardId, CardId];
} | {
    kind: "advanced-super-three-raid";
    sourceCardIds: [CardId, CardId];
    targetPlayerId: PlayerId;
    takeCardIds: CardId[];
} | {
    kind: "advanced-super-five-recycle";
    sourceCardIds: [CardId, CardId];
    rummageCardIds: CardId[];
} | {
    kind: "advanced-super-six-dig";
    sourceCardIds: [CardId, CardId];
    discardCardIds: CardId[];
    keepCardIds: CardId[];
} | {
    kind: "advanced-super-seven-topdeck";
    sourceCardIds: [CardId, CardId];
    handCardIds: CardId[];
    effectCardIds: CardId[];
    scoreCardIds: CardId[];
} | {
    kind: "advanced-rank10-club-foundation";
    sourceCardId: CardId;
    ...
    mimickedRank: string;
    effectKey: string;
    mimicAction: MimicCopiedAction;
} | {
    kind: "advanced-ultra-three-black";
    sourceCardIds: [CardId, CardId, CardId];
    scoreCardId: CardId;
    castCardId: CardId;
    exileCardId: CardId;
    castEffect: CoreEffectAction;
} | {
    kind: "advanced-ultra-two-black-two-red";
    sourceCardIds: [CardId, CardId, CardId, CardId];
    branch: "draw-two" | "rummage-exile";
    rummageCardId?: CardId;
} | {
    kind: "advanced-voltage-three";
    chosenCardId?: CardId;
    disposition: "hand" | "points";
} | {
...
export type CorePrimaryAction = {
    ...
    kind: "core-resolve-generated-effect";
    effect: CoreEffectAction;
...
export type CoreStackPayload = {
    ...
    stackClass: "draw" | "swap" | "points" | "ordinary-effect" | "anchor" | "scuttle" | "pass" | "super" | "ultra" | "royal-marriage" | "queens-court" | "rank10" | "voltage";
} | {
    kind: "response";
    responseKind: CoreResponseKind;
    targetStackItemId?: StackItemId;
...
export type CoreEffectAction = {
    ...
    sourceCardId: CardId;
    targetCardId: CardId;
    mode: "scrap-aegis" | "bounce-anchor";
} | {
    kind: "ace-anchor";
    sourceCardId: CardId;
} | {
...
export type CoreAuthorityAction = {
    ...
    semantic: "DECLINE_RESPONSE" | "AUTOMATIC_PRIORITY_ADVANCE";
} | {
    kind: "core-declare-base-ace-counter";
    sourceCardId: CardId;
    targetStackItemId: StackItemId;
    sourceMode: "hand" | "anchor";
} | {
    kind: "core-declare-spade-ace-counter";
    sourceCardId: CardId;
    targetStackItemId: StackItemId;
} | {
    kind: "core-declare-eight-scuttle-counter";
    sourceCardId: CardId;
    targetStackItemId: StackItemId;
} | {
    ...
    kind: "core-declare-super-ace-counter";
    sourceCardIds: [CardId, CardId];
    targetStackItemId: StackItemId;
} | {
    kind: "core-declare-king-spade-counter";
    sourceCardId: CardId;
    targetStackItemId: StackItemId;
} | {
    kind: "core-declare-rank10-stack-theft";
    sourceCardId: CardId;
    targetStackItemId: StackItemId;
} | {
...
export type EngineCommand = {
    ...
    actorId: PlayerId;
    action: CoreAuthorityAction;
};
export type SoloWildCopiedAction = {
    kind: "three-bounce";
    targetCardId: CardId;
} | {
    kind: "four-row-clear";
...
export type RankAction = {
    ...
    kind: "solo-wild-copy";
    sourceCardId: CardId;
    targetRank: "3" | "4" | "5" | "6" | "7";
    copiedAction: SoloWildCopiedAction;
} | {
    kind: "wild-sovereignty";
    sourceCardId: CardId;
    targetRank: "3" | "4" | "5" | "6" | "7";
    copiedAction: SoloWildCopiedAction;
    discardCostCardId?: CardId;
} | {
    kind: "total-clear";
    sourceCardId: CardId;
} | {
...
export type FirstContactAction = {
    ...
    kind: "autonomy-declare-response-action";
    action: FirstContactPrimaryAction;
} | {
    kind: "autonomy-declare-ace-counter";
    sourceCardId: CardId;
    targetStackItemId: StackItemId;
} | {
    kind: "autonomy-declare-eight-scuttle-counter";
    sourceCardId: CardId;
    targetStackItemId: StackItemId;
} | {
    kind: "autonomy-declare-king-counter";
    sourceCardId: CardId;
    targetStackItemId: StackItemId;
} | {
    kind: "autonomy-declare-jack-disrupt";
    sourceCardId: CardId;
    targetStackItemId: StackItemId;
} | {
    ...
    kind: "autonomy-submit-private-choice";
    token: string;
    submission: FirstContactPrivateChoiceSubmission;
} | {
...
export type CounterTargetClass = "ordinary-effect" | "counter" | "single-anchor" | "single-goal" | "multi-play" | "royal-marriage" | "queens-court" | "ace-spade" | "ultra" | "sudden-death" | "scuttle" | "triggered-ability";
