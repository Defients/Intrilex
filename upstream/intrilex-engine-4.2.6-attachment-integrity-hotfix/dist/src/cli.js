...
if (command === "conformance") {
    ...
    if (parsed.version === 2) {
        ...
        const result = replayAndVerify(parsed);
    ...
    console.log(`SIMULATION PASS: scenarios=${String(report.scenarioBaseline.scenarioCount)}; matches=${String(report.fullMatchCampaign.matchCount)}; catalog=${report.catalogHash}`);
}
