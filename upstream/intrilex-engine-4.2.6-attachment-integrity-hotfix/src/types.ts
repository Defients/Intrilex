...
export type FirstContactPrivateChoiceSubmission =
  ...
  | { kind: "rank7-assign"; mode: "hand-only" | "effect-only" | "hand-and-effect" | "score-only" | "hand-and-score"; selectedCardIds: CardId[] }
  | { kind: "rank7-generated-effect"; selectedCardIds: CardId[]; generatedAction?: FirstContactPrimaryAction; scoreInstead?: boolean }
...
export type CoreAdvancedAction =
  ...
  | { kind: "advanced-queens-court"; queenCardIds: [CardId, CardId] }
  ...
  | { kind: "advanced-super-three-raid"; sourceCardIds: [CardId, CardId]; targetPlayerId: PlayerId; takeCardIds: CardId[] }
  | { kind: "advanced-super-five-recycle"; sourceCardIds: [CardId, CardId]; rummageCardIds: CardId[] }
  | { kind: "advanced-super-six-dig"; sourceCardIds: [CardId, CardId]; discardCardIds: CardId[]; keepCardIds: CardId[] }
  | { kind: "advanced-super-seven-topdeck"; sourceCardIds: [CardId, CardId]; handCardIds: CardId[]; effectCardIds: CardId[]; scoreCardIds: CardId[] }
  ...
  | { kind: "advanced-rank10-diamond-mimic"; sourceCardId: CardId; pairedTwoId?: CardId; mimickedRank: string; effectKey: string; mimicAction: MimicCopiedAction }
...
export type CorePrimaryAction =
  ...
  | { kind: "core-resolve-rank-action"; action: RankAction }
...
export type CoreAuthorityAction =
  ...
  | { kind: "core-pass-priority"; semantic: "DECLINE_RESPONSE" | "AUTOMATIC_PRIORITY_ADVANCE" }
...
export type SoloWildCopiedAction =
  | { kind: "three-bounce"; targetCardId: CardId }
...
export type MimicCopiedAction =
  | { kind: "row-exchange"; targetPlayerId: PlayerId; row: "pr" | "er" }
  | { kind: "absolute-scuttle"; targetCardId: CardId }
  | { kind: "super-j-tempo" }
  | { kind: "topdeck-seven"; handCardId?: CardId; effectCardId?: CardId; scoreCardId?: CardId }
  | { kind: "recycle-five"; rummageCardId?: CardId };
...
export type RankAction =
  ...
  | { kind: "solo-wild-copy"; sourceCardId: CardId; targetRank: "3" | "4" | "5" | "6" | "7"; copiedAction: SoloWildCopiedAction }
  | { kind: "wild-sovereignty"; sourceCardId: CardId; targetRank: "3" | "4" | "5" | "6" | "7"; copiedAction: SoloWildCopiedAction; discardCostCardId?: CardId }
...
export type FirstContactAction =
  ...
  | { kind: "autonomy-pass-priority"; semantic: "DECLINE_RESPONSE" | "AUTOMATIC_PRIORITY_ADVANCE" }
