...
export declare function coreAuthorityCapabilities(): ({
    ...
    moduleSets: never[][];
    status: string;
    completeActionFamilies: ("draw" | "play-for-points" | "scuttle" | "pass" | "face-up-swap" | "face-down-swap")[];
    reasonCodes: string[];
} | {
    ...
    moduleSets: never[][];
    status: string;
    completeActionFamilies: ("draw" | "play-for-points" | "scuttle" | "pass" | "face-up-swap" | "A-purge" | "A-anchor" | "3-bounce" | "4-row-clear" | "4-spade-total-clear" | "J-attachment" | "Q-anchor" | "K-anchor" | "RJ-four-modes" | "BJ-board-lock" | "face-down-swap")[];
    reasonCodes: string[];
} | {
    ...
    moduleSets: never[][];
    status: string;
    completeActionFamilies: ("draw" | "play-for-points" | "scuttle" | "pass" | "face-up-swap" | "king-spade-counter" | "rank10-stack-theft" | "ultra-three-red" | "royal-marriage" | "super-ace" | "A-purge" | "A-anchor" | "3-bounce" | "4-row-clear" | "4-spade-total-clear" | "J-attachment" | "Q-anchor" | "K-anchor" | "RJ-four-modes" | "BJ-board-lock" | "3-present-take" | "3-force-discard" | "5-recycle-rummage" | "6-deep-dig" | "7-topdeck-casting" | "9-anchor-discard" | "super-two-score" | "super-four-exchange" | "super-eight" | "super-jack" | "rank10-heart" | "rank10-spade-recovery" | "ultra-three-black-public" | "ultra-two-black-two-red" | "voltage-five-gy-bottom" | "A-base-counter" | "A-anchor-counter" | "A-spade-exile-counter" | "8-scuttle-counter" | "8-spade-free-scuttle" | "8-aegis-field-quick" | "9-tap" | "J-disrupt" | "Q-aegis-quick" | "K-anchor-counter" | "face-down-swap")[];
    reasonCodes: string[];
})[];
