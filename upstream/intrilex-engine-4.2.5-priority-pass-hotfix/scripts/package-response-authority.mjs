...
await copyFile(path.join(root, 'RESPONSE_AUTHORITY_MANIFEST.json'), path.join(release, 'RESPONSE_AUTHORITY_MANIFEST.json'));
await copyFile(path.join(root, 'reports/BUILD_PROOF_4.1.3.md'), path.join(release, 'BUILD_PROOF.md'));
