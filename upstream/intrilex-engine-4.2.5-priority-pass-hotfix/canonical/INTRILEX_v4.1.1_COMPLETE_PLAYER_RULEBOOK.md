# INTRILEX — Complete Player Rulebook v4.1.1

> **Edition:** Player-focused complete rules  
> **Rules basis:** Canonical v4.0 contract plus the accepted July 2026 forensic clarification set, canonized as v4.1; v4.1.1 timing hotfix applied  
