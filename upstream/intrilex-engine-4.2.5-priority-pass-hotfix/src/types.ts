...
export type CoreAdvancedAction =
  ...
  | { kind: "advanced-super-seven-topdeck"; sourceCardIds: [CardId, CardId]; handCardIds: CardId[]; effectCardIds: CardId[] }
...
export type SoloWildCopiedAction =
  ...
  | { kind: "topdeck-seven"; handCardId?: CardId; effectCardId?: CardId };
