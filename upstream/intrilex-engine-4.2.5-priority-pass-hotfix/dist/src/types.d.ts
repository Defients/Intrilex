...
export type FirstContactPrivateChoiceSubmission = {
    ...
    kind: "rank7-assign";
    mode: "hand-only" | "effect-only" | "hand-and-effect";
    selectedCardIds: CardId[];
} | {
...
export type CoreResponseKind = "base-ace-counter" | "anchor-ace-counter" | "spade-ace-counter" | "eight-scuttle-counter" | "king-anchor-counter" | "jack-disrupt" | "nine-tap" | "eight-spade-free-scuttle" | "eight-aegis-field" | "queen-aegis-quick" | "super-ace-counter" | "king-spade-counter" | "rank10-stack-theft" | "ultra-three-red";
export type CoreStackPayload = {
    kind: "primary";
    action: CorePrimaryAction;
    declaringPlayerId: PlayerId;
    actionType: CoreFoundationActionType;
    stackClass: "draw" | "swap" | "points" | "ordinary-effect" | "anchor" | "scuttle" | "pass" | "super" | "ultra" | "royal-marriage" | "rank10" | "voltage";
} | {
    kind: "response";
