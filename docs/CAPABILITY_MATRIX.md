...
> Reconciled against code truth for v0.28.2 (Official Rules v4.3.1 on Engine v4.2.6).
...
| Voltage 3 (hand/points) | SUPPORTED |
| Voltage 4 (guess prediction) | SUPPORTED |
| Voltage 5 Refine (discard+draw) | SUPPORTED |
| Special scoring riders (7/10♣/BJ) | SUPPORTED |
| Watch and replay investigation | SUPPORTED |
| History (campaign match telemetry browser) | SUPPORTED |
| Semantic telemetry and causal facts | SUPPORTED |
| Mechanics Atlas | SUPPORTED |
| Synergy Observatory | SUPPORTED |
| Policy/matchup comparison | SUPPORTED |
| Evidence-linked drill-down | SUPPORTED |
| Browser multi-worker campaign parallelism | SUPPORTED |
| Node, Chromium, Web Worker, worker-thread parity | SUPPORTED |
| Decision traces (schema v2.0.0) | SUPPORTED |
